import type { GalleryProps, SectionStyle, SectionLayout } from '@resolute/shared';
...
export default function Gallery({ id, props, sectionStyle, layout }: { id: string; props: GalleryProps; sectionStyle?: SectionStyle; layout?: SectionLayout }) {
      ...
      <div className="max-w-[1180px] mx-auto">
        {(props.kicker || props.title) && (
          <div className="text-center mb-[44px]">
            ...
            {props.title && <h2 {...el('title', 'm-0 font-display font-black uppercase leading-[0.9] tracking-[-0.01em] text-[clamp(2.2rem,5vw,4rem)]')}>{props.title}</h2>}
          </div>
        )}
        <div {...el('grid', `grid grid-cols-1 gap-[14px] ${COLS[props.columns]}`)}>
